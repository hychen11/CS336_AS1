...
from cs336_basics.Transformer import Linear, Embedding, RMSNorm, SwiGLU, RotaryPositionalEmbedding, softmax, scaled_dot_product_attention, MultiheadSelfAttention, TransformerBlock, TransformerLm, cross_entropy, get_lr_cosine_schedule, gradient_clipping, get_batch, save_checkpoint, load_checkpoint
...
def run_multihead_self_attention(
    ...
    multihead_self_attention.q.weight.data = q_proj_weight
    multihead_self_attention.k.weight.data = k_proj_weight
    multihead_self_attention.v.weight.data = v_proj_weight
    multihead_self_attention.o.weight.data = o_proj_weight
